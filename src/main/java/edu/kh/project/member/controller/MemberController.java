...
public class MemberController {
	...
	public String login(Member inputMember,
		...
		if(loginMember != null) {
			...
			// saveId=gggeee@gmail.com
			
			// 클라이언트가 어떤 요청을 할 때 구키가 첨부될지 지정
	...
	/** 로그아웃 : Session에 저장된 로그인 된 회원 정보를 없앰(만료, 무효화)
	 * 
	 * @param SesstionStatus : 세션을 완료(없앰) 시키는 역할의 객체
	 ...
	 * 						 memberTel, (memberAddress - 따로받아서 처리)
	 * 
